...
{#if !isInAuth}
	<header
		class="sticky bottom-0 z-40 w-full px-6 pb-2 md:bottom-[none] md:top-0 md:pb-0 md:pt-2"
	>
		<div
			class="bg-card border-border mx-auto flex h-14 w-full items-center rounded-sm border px-8 text-neutral-700 md:bg-transparent"
		>
			<div>
