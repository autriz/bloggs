		...
		{#each tree as heading, i (i)}
			<li class="mt-0 pt-2">
				<a
					...
					class="hover:!text-secondary-foreground/80 data-[active]:text-secondary-foreground/70
                        text-secondary-foreground/50 inline-flex items-center justify-center gap-1
